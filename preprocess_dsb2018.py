...
from glob import glob #finding all paths that match specific pattern

import cv2 #an open source computer vision library
...
def main():
    ...
    paths = glob('/workspaces/Transfer_learning_with_resnet/inputs/data-science-bowl-2018/stage1_train/*')
